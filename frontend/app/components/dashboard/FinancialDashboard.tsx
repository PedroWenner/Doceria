...
export default function FinancialDashboard() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/dashboard/financial-summary`, {
    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            {/* Header / Title (Optional if main page has it) */}
            <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm">
                    ...
                    <FinancialOverviewChart data={data.overview} />
                </div>
