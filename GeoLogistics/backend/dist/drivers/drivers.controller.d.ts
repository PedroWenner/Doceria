...
export declare class DriversController {
    ...
    create(createDriverDto: CreateDriverDto, apiKey?: string): Promise<import("./entities/driver.entity").Driver>;
    findAll(type?: string, apiKey?: string): Promise<import("./entities/driver.entity").Driver[]>;
